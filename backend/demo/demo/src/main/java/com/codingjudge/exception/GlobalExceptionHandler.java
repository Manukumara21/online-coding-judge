...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<AuthResponse> handleBadRequestException(BadRequestException ex) {
    ...
    public ResponseEntity<AuthResponse> handleGenericException(Exception ex) {
        AuthResponse response = new AuthResponse(false, "An error occurred: " + ex.getMessage());
